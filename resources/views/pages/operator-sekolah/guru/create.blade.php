                    ...
                    <form action="{{ route('data-guru.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 row" id="sertifikasi_alasan_row" style="display: none;">
                                    <label class="col-sm-4 col-form-label">Jika belum sertifikasi, alasannya apa?</label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control" name="sertifikasi_alasan" id="sertifikasi_alasan"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 row" id="sertifikasi_tahun_row" style="display: none;">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 row">
                                    <label for="kompetensi_jaringan" class="col-sm-6 col-form-label">Jaringan
                                        Komputer</label>
                                    <div class="col-sm-6">
                                        <select name="kompetensi_jaringan" id="kompetensi_jaringan" class="form-select"
                                            required>
                                            <option value="3">Mahir</option>
                                            <option value="2">Menengah</option>
                                            <option value="1">Dasar</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 row">
                                    <label for="kompetensi_multimedia" class="col-sm-6 col-form-label">Multimedia (Adobe
                                        Photoshop, Adobe Premiere, Capcut, dll)</label>
                                    <div class="col-sm-6">
                                        <select name="kompetensi_multimedia" id="kompetensi_multimedia"
                                            class="form-select" required>
                                            <option value="3">Mahir</option>
                                            <option value="2">Menengah</option>
                                            <option value="1">Dasar</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 row align-items-center">
                                    <label for="pelatihan_kebutuhan" class="col-sm-4 col-form-label form-label fs-6">
                                        Ada kebutuhan pelatihan?
                                    </label>
                                    <div class="col-sm-8">
                                        <select name="pelatihan_kebutuhan" id="pelatihan_kebutuhan" class="form-select"
                                            required>
                                            <option value="">-- Pilih --</option>
                                            <option value="Ya">Ya</option>
                                            <option value="Tidak">Tidak</option>
                            ...
                            <!-- Container kebutuhan pelatihan -->
                            <div id="kebutuhan_container" style="display: none;">
...
@section('scripts')
    ...
    <script>
        ...
        document.getElementById('kebutuhan_list').addEventListener('click', function(e) {
            if (e.target && e.target.classList.contains('btn-remove-sm')) {
                ...
                if (rows.length > 1) {
                    e.target.closest('.kebutuhan_row').remove();
                } else {
                    alert('Minimal 1 baris harus ada.');
                }
            }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const select = document.getElementById("sertifikasi_status");
            const alasanRow = document.getElementById("sertifikasi_alasan_row");
            const tahunRow = document.getElementById("sertifikasi_tahun_row");
