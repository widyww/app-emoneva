            ...
            $.getJSON(url)
                .done(function(data) {
                    ...
                    data.labels.forEach(label => {
                        colorsMap[label] = label === 'Ya' ? '#63e6be' : '#ff8787'; // Premium mint-green / coral-red
                    });
        ...
        function loadSekolahDetail(kotaId, statusBantuan) {
            ...
            `;
                    ...
                    dataSekolah.forEach(sekolah => {
                        ...
                        // === DETAIL BANTUAN ===
                        if (Array.isArray(sekolah.bantuan_details) && sekolah.bantuan_details.length > 0) {
                            sekolah.bantuan_details.forEach(detail => {
                                bantuanHTML += `
                            <li>
                                <strong>${detail.nama_lembaga}</strong><br>
                                <span class="text-muted">${detail.keterangan_bantuan}</span>
                            </li>
                        `;
                            });
                        } else {
                            bantuanHTML += "<li>Tidak ada detail bantuan yang tercatat.</li>";
                        }
